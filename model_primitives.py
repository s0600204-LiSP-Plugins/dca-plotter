...
class ModelsAssignRow(ModelsResetRow):
    ...
    def __init__(self, cue=None, **kwargs):
        ...
        for _ in range(get_plugin('DcaPlotter').SessionConfig['dca_count']):
...
class DcaModelTemplate(QAbstractItemModel):
    ...
    def _addNode(self, destination, new_node):
    ...
    def _clearNode(self, node_index):
    ...
    def _relocateNode(self, node_index, destination):
    ...
    def _removeNode(self, node_index):
